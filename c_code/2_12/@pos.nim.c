...
colontmpD__2 = substr__system_u8324(path_p0, ((NI) 2));
...
colontmp_.len = 0;
colontmp_.p = NIM_NIL;
colontmp_ = getEnv__stdZenvvars_u16(TM__yu6cxgKBBXbNsTkT9cyMd4g_18, TM__yu6cxgKBBXbNsTkT9cyMd4g_19);
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA8_;
}
...
T20_.len = 0;
T20_.p = NIM_NIL;
T20_ = substr__system_u8311(colontmp_, firstX60gensym37__1, ((NI) (lastX60gensym37__1 - ((NI) 1))));
...
result.len = 0;
result.p = NIM_NIL;
result = getApplAux__pureZos_u185(TM__yu6cxgKBBXbNsTkT9cyMd4g_16);
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
{
...
T7_.len = 0;
T7_.p = NIM_NIL;
T7_ = getApplHeuristic__pureZos_u189();
if (NIM_UNLIKELY((*nimErr_))) {
...
if (isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 258371072)) {
	(*nimErr_) = NIM_FALSE;
eqsink___system_u2633(((&result)), TM__yu6cxgKBBXbNsTkT9cyMd4g_20);
popCurrentException();
LA9_: ;
}
}
...
LA9_: ;
path_1 = getEnv__stdZenvvars_u16(TM__yu6cxgKBBXbNsTkT9cyMd4g_22, TM__yu6cxgKBBXbNsTkT9cyMd4g_23);
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA1_;
}
{
...
T32_.len = 0;
T32_.p = NIM_NIL;
T32_ = substr__system_u8311(path_1, firstX60gensym34__1, ((NI) (lastX60gensym34__1 - ((NI) 1))));
