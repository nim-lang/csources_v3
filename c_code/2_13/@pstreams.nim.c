...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___system_u8421)(tyObject_IOError__WVAESVwIK7kcfBPG39aq7xQ* dest_p0);
...
result = NIM_NIL;
eqdestroy___system_u8421(result);
