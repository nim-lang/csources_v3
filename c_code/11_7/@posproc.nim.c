...
N_LIB_PRIVATE N_NIMCALL(void, rttiDestroy__pureZosproc_u2041)(void* dest_p0);
...
N_LIB_PRIVATE N_NIMCALL(NCSTRING*, allocCStringArray__system_u3807)(NimStringV2* a_p0, NI a_p0Len_0);
...
N_LIB_PRIVATE N_NIMCALL(void, deallocCStringArray__system_u3861)(NCSTRING* a_p0);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_FileStreamObj__LbEzkl9aTALZDJEfP9c09a3QQ*, createStream__pureZosproc_u1143)(int* handle_p0, tyEnum_FileMode__m6ZEz9b9czV5YJ5lg4IK9bc4Q fileMode_p1);
...
N_LIB_PRIVATE N_NIMCALL(tyObject_Duration__9a5KKVFQu9aw9aFWUw85rsDCw, min__pureZosproc_u1089)(tyObject_Duration__9a5KKVFQu9aw9aFWUw85rsDCw* x_p0, NI x_p0Len_0);
...
static const struct {
	NI cap;
	NIM_CHAR data[15];
} TM__HZdw8BhppcTQo8DIK46LSg_5 = {(14 | NIM_STRLIT_FLAG), "/system/bin/sh"};
static const NimStringV2 TM__HZdw8BhppcTQo8DIK46LSg_6 = {14, ((NimStrPayload*) (&TM__HZdw8BhppcTQo8DIK46LSg_5))};
static const NimStringV2 TM__HZdw8BhppcTQo8DIK46LSg_7 = {14, ((NimStrPayload*) (&TM__HZdw8BhppcTQo8DIK46LSg_5))};
static const struct {
	NI cap;
	NIM_CHAR data[3];
...
T7_ = ((void*) 0);
T7_ = alloc0Impl__system_u1742((((NI) (((NI) (counter_1 + ((NI) 1))) * ((NI) 4)))));
result = ((NCSTRING*) (T7_));
i_2 = ((NI) 0);
{
	NimStringV2 key_2;
...
void* T15_;
T12_ = ((NIM_BOOL) 0);
T12_ = eqeq___system_u8284(environ[i_3], ((NCSTRING) NIM_NIL));
if ((!((!(T12_))))) {
	goto LA11;
}
kv_2.len = 0;
...
i_3 += ((NI) 1);
p_2 = find__pureZparseutils_u636(kv_2, 61);
T13_.Field0 = substr__system_u8340(kv_2, ((NI) 0), ((NI) (p_2 - ((NI) 1))));
T13_.Field1 = substr__system_u8353(kv_2, ((NI) (p_2 + ((NI) 1))));
...
T2_ = ((void*) 0);
T2_ = alloc0Impl__system_u1742((((NI) (((NI) (T1_ + ((NI) 1))) * ((NI) 4)))));
result = ((NCSTRING*) (T2_));
i_1 = ((NI) 0);
{
	NimStringV2 key_1;
...
LA27_: ;
flags_1 = ((NI32) (((int) 64) | POSIX_SPAWN_SETSIGMASK));
{
	if ((!((((*data_p0).options & (((NU8) 1) << (((NU) ((tyEnum_ProcessOption__9aCfVUyDFjLLn9an3vvc7WLw) 6)) & 7U))) != 0)))) {
	goto LA37_;
}
flags_1 = ((NI32) (flags_1 | POSIX_SPAWN_SETPGROUP));
}
LA37_: ;
{
	int T41_;
...
LA18_: ;
pid_1 = ((pid_t) 0);
sysArgs_1 = allocCStringArray__system_u3807(((sysArgsRaw_1).p ? (sysArgsRaw_1).p->data : NIM_NIL), sysArgsRaw_1.len);
...
setCurrentDir__stdZprivateZosdirs_u501(currentDir_1);
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA33_;
}
}
...
{
	deallocCStringArray__system_u3861(sysEnv_1);
}
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA26_;
}
...
{
	deallocCStringArray__system_u3861(sysArgs_1);
}
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA1_;
}
...
{
	eqdestroy___system_u3716(sysArgsRaw_1);
...
T5_ = (&(*p_p0).inStream);
T6_ = NIM_NIL;
T6_ = createStream__pureZosproc_u1143(((&(*p_p0).inHandle)), ((tyEnum_FileMode__m6ZEz9b9czV5YJ5lg4IK9bc4Q) 1));
if (NIM_UNLIKELY((*nimErr_))) {
...
T5_ = (&(*p_p0).outStream);
T6_ = NIM_NIL;
T6_ = createStream__pureZosproc_u1143(((&(*p_p0).outHandle)), ((tyEnum_FileMode__m6ZEz9b9czV5YJ5lg4IK9bc4Q) 0));
if (NIM_UNLIKELY((*nimErr_))) {
	eqdestroy___pureZstreams_u980(T6_);
	goto BeforeRet_;
}
...
pid_t pid_1;
status_2 = ((int) 0);
pid_1 = waitpid((*p_p0).id, ((&status_2)), WNOHANG);
{
	if ((!(((*p_p0).id == pid_1)))) {
	goto LA22_;
}
...
T45_[0] = T46_;
T45_[1] = remaining_1;
T45_[2] = maxWait__pureZosproc_u1067;
delay_1 = min__pureZosproc_u1089(T45_, 3);
}
LA29_: ;
}
LA20_: ;
