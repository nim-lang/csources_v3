...
N_LIB_PRIVATE N_NOINLINE(tyObject_OSError__Rw9ambrEYSqg7o77XNSnlyw*, newOSError__stdZoserrors_u53)(NI32 errorCode_p0, NimStringV2 additionalInfo_p1);
...
T10_ = ((NIM_CHAR*) 0);
T10_ = X5BX5D___system_u7800(((&(*result).Sup.Sup.message)), ((NI) 1));
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
T8_ = (!((((NU8) (*T10_)) == ((NU8) 10))));
