...
T5_.len = 0;
T5_.p = NIM_NIL;
T5_ = substr__system_u8346(p_p0, ((NI) (checksumSeparatorIndex_1 + ((NI) 1))));
...
T16_.len = 0;
T16_.p = NIM_NIL;
T16_ = substr__system_u8333(p_p0, ((NI) (versionSeparatorIndex_1 + ((NI) 1))), ((NI) (checksumSeparatorIndex_1 - ((NI) 1))));
...
T22_.len = 0;
T22_.p = NIM_NIL;
T22_ = substr__system_u8333(p_p0, ((NI) (versionSeparatorIndex_1 + ((NI) 1))), ((NI) (checksumSeparatorIndex_1 - ((NI) 1))));
...
eqdestroy___system_u3719(sVer2_1);
eqdestroy___system_u3719(sVer_1);
goto BeforeRet_;
{
	LA15_: ;
}
...
eqwasMoved___system_u3716(((&resultX60gensym40__1)));
{
	NI T20_;
...
colontmpD_.len = 0;
colontmpD_.p = NIM_NIL;
colontmpD_ = readFile__stdZsyncio_u527((nimbleLinks_1).p->data[((NI) 0)]);
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA23_;
}
...
{
	eqdestroy___system_u2624(colontmpD_);
eqdestroy___system_u3719(nimbleLinkLines_1);
}
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA1_;
}
...
{
	eqdestroy___system_u3719(resultX60gensym40__1);
eqdestroy___system_u3719(nimbleLinks_1);
