...
T5_.len = 0;
T5_.p = NIM_NIL;
T5_ = substr__system_u8335(p_p0, ((NI) (checksumSeparatorIndex_1 + ((NI) 1))));
...
T16_.len = 0;
T16_.p = NIM_NIL;
T16_ = substr__system_u8322(p_p0, ((NI) (versionSeparatorIndex_1 + ((NI) 1))), ((NI) (checksumSeparatorIndex_1 - ((NI) 1))));
...
T22_.len = 0;
T22_.p = NIM_NIL;
T22_ = substr__system_u8322(p_p0, ((NI) (versionSeparatorIndex_1 + ((NI) 1))), ((NI) (checksumSeparatorIndex_1 - ((NI) 1))));
...
eqdestroy___system_u3717(sVer2_1);
eqdestroy___system_u3717(sVer_1);
goto BeforeRet_;
{
	LA15_: ;
}
...
eqwasMoved___system_u3714(((&resultX60gensym40__1)));
{
	NI T20_;
...
{
	eqdestroy___system_u2624(colontmpD_);
eqdestroy___system_u3717(nimbleLinkLines_1);
}
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA1_;
}
...
{
	eqdestroy___system_u3717(resultX60gensym40__1);
eqdestroy___system_u3717(nimbleLinks_1);
