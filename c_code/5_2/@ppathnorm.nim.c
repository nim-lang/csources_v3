...
{
	NI d_1;
if ((!((((NI) 1) <= ((NI) (((NI64) (*state_p2)) >> ((NU64) ((NI) 1)))))))) {
	goto LA30_;
}
d_1 = (*result_p1).len;
{
...
LA45_: ;
colontmpD_ = substr__system_u8343(x_p0, b_1.Field0, b_1.Field1);
...
LA58_: ;
colontmpD__2 = substr__system_u8343(x_p0, b_1.Field0, b_1.Field1);
