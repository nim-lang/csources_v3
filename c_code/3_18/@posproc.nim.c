...
T8_ = ((void*) 0);
T8_ = alloc0Impl__system_u1742((((NI) (((NI) (counter_1 + ((NI) 1))) * ((NI) 8)))));
result = ((NCSTRING*) (T8_));
i_2 = ((NI) 0);
{
	NimStringV2 key_2;
...
void* T17_;
T14_ = ((NIM_BOOL) 0);
T14_ = eqeq___system_u8303(gEnv_2[i_3], ((NCSTRING) NIM_NIL));
if ((!((!(T14_))))) {
	goto LA13;
}
kv_2.len = 0;
...
T15_.Field0 = substr__system_u8359(kv_2, ((NI) 0), ((NI) (p_2 - ((NI) 1))));
T15_.Field1 = substr__system_u8372(kv_2, ((NI) (p_2 + ((NI) 1))));
