...
int status_1;
int status2_1;
state_1 = copyfile_state_alloc();
status_1 = copyfile(nimToCStringConv(source_p0), nimToCStringConv(dest_p1), state_1, COPYFILE_DATA);
{
...
T29_.Field1 = dest_p1;
colontmpD__2 = dollar___stdZprivateZoscommon_u94(((&T29_)));
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA27_;
}
...
LA25_: ;
status2_1 = copyfile_state_free(state_1);
{
...
T38_.Field1 = dest_p1;
colontmpD__3 = dollar___stdZprivateZoscommon_u94(((&T38_)));
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA36_;
}
...
copyFileWithPermissions__stdZprivateZosfiles_u387(source_p0, dest_p1, NIM_TRUE, 1);
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
