...
N_LIB_PRIVATE N_NIMCALL(NCSTRING*, allocCStringArray__system_u3810)(NimStringV2* a_p0, NI a_p0Len_0);
...
N_LIB_PRIVATE N_NIMCALL(void, deallocCStringArray__system_u3864)(NCSTRING* a_p0);
...
void* T15_;
T12_ = ((NIM_BOOL) 0);
T12_ = eqeq___system_u8277(environ[i_3], ((NCSTRING) NIM_NIL));
if ((!((!(T12_))))) {
	goto LA11;
}
kv_2.len = 0;
...
T13_.Field0 = substr__system_u8333(kv_2, ((NI) 0), ((NI) (p_2 - ((NI) 1))));
T13_.Field1 = substr__system_u8346(kv_2, ((NI) (p_2 + ((NI) 1))));
...
LA18_: ;
pid_1 = ((pid_t) 0);
sysArgs_1 = allocCStringArray__system_u3810(((sysArgsRaw_1).p ? (sysArgsRaw_1).p->data : NIM_NIL), sysArgsRaw_1.len);
...
{
	deallocCStringArray__system_u3864(sysEnv_1);
}
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA26_;
}
...
{
	deallocCStringArray__system_u3864(sysArgs_1);
}
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA1_;
}
...
{
	eqdestroy___system_u3719(sysArgsRaw_1);
