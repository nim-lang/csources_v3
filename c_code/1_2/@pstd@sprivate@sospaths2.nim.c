...
T4_ = ((NIM_CHAR) 0);
T4_ = X5BX5D___system_u7822(tail_p2, ((NI) 1));
...
T10_ = ((NIM_CHAR*) 0);
T10_ = X5BX5D___system_u7874(result_p0, ((NI) 1));
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
...
T20_.len = 0;
T20_.p = NIM_NIL;
T20_ = substr__system_u8407(path_p0, ((NI) 0), T13_);
eqsink___system_u2633(((&(*Result).Field0)), T20_);
T21_.len = 0;
T21_.p = NIM_NIL;
T21_ = substr__system_u8420(path_p0, ((NI) (sepPos_1 + ((NI) 1))));
...
T22_.len = 0;
T22_.p = NIM_NIL;
T22_ = substr__system_u8407(path_p0, ((NI) 0), T15_);
...
T27_.len = 0;
T27_.p = NIM_NIL;
T27_ = substr__system_u8407(path_p0, namePos_1, ((NI) (dotPos_1 - ((NI) 1))));
eqsink___system_u2633(((&(*Result).Field1)), T27_);
T28_.len = 0;
T28_.p = NIM_NIL;
T28_ = substr__system_u8420(path_p0, dotPos_1);
...
T30_.len = 0;
T30_.p = NIM_NIL;
T30_ = substr__system_u8420(path_p0, namePos_1);
...
{
	NI T8_;
splitDrive__stdZprivateZntpath_u2(path1_p0, ((&colontmpD_)));
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
...
T67_ = ((NIM_CHAR*) 0);
T67_ = X5BX5D___system_u7874(((&result)), ((NI) 1));
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA1_;
}
...
T85_ = ((NIM_CHAR*) 0);
T85_ = X5BX5D___system_u7874(((&result)), ((NI) 1));
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA1_;
}
...
T5_.len = 0;
T5_.p = NIM_NIL;
T5_ = substr__system_u8407(result, ((NI) 0), sepPos_1);
...
T13_ = ((NIM_CHAR*) 0);
T13_ = X5BX5D___system_u7874(((&result)), ((NI) 1));
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
...
T7_.len = 0;
T7_.p = NIM_NIL;
colontmpD__2 = substr__system_u8407(filename_p0, ((NI) 0), ((NI) (extPos_1 - ((NI) 1))));
