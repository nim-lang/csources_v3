...
N_LIB_PRIVATE N_NOINLINE(tyObject_OSError__Rw9ambrEYSqg7o77XNSnlyw*, newOSError__stdZoserrors_u57)(NI32 errorCode_p0, NimStringV2 additionalInfo_p1);
...
extern tyProc__aO673xGTLLxou7P7GxoCXA Dl_1442840750_;
extern tyProc__im9buRnIvptJfzdASYMEbBA Dl_1442840758_;
...
NimStringV2 T10_;
T7_ = ((NI32) 0);
T7_ = Dl_1442840750_(((NI32) 4864), NIM_NIL, errorCode_p0, ((NI32) 0), ((void*) ((&msgbuf_1))), ((NI32) 0), NIM_NIL);
if ((!((!((T7_ == ((NI32) 0))))))) {
	goto LA8_;
}
T10_.len = 0;
...
eqsink___system_u2633(((&result)), T10_);
{
	if ((!((!((msgbuf_1 == ((NI16*) NIM_NIL))))))) {
	goto LA13_;
}
Dl_1442840758_(((void*) (msgbuf_1)));
}
LA13_: ;
}
LA8_: ;
...
T10_ = ((NIM_CHAR*) 0);
T10_ = X5BX5D___system_u7874(((&(*result).Sup.Sup.message)), ((NI) 1));
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
T8_ = (!((((NU8) (*T10_)) == ((NU8) 10))));
...
if (NIM_UNLIKELY((*nimErr_))) {
	eqdestroy___stdZoserrors_u102(T1_);
	goto BeforeRet_;
}
