...
extern tyProc__9bXHKfH08cKXphxNi5GYejg Dl_1442840859_;
static N_INLINE(void, nimAddCharV1)(NimStringV2* s_p0, NIM_CHAR c_p1) {
...
if (NIM_UNLIKELY((*nimErr_))) {
	eqdestroy___system_u3714(T6_);
	goto BeforeRet_;
}
eqsink___system_u3723(((&ownArgv__stdZcmdline_u71)), T6_);
ownParsedArgv__stdZcmdline_u72 = NIM_TRUE;
eqdestroy___system_u2624(colontmpD_);
}
LA3_: ;
T7_ = ownArgv__stdZcmdline_u71.len;
result = ((NI) (T7_ - ((NI) 1)));
}
	BeforeRet_: ;
		return result;
...
eqcopy___system_u2627(((&result)), (ownArgv__stdZcmdline_u71).p->data[i_p0]);
}
goto LA7_;
LA12_: ;
{
...
tyObject_IndexDefect__CqGtyJBJ5yAT9bbFUV4tGLw* T16_;
colontmpD__2.len = 0;
colontmpD__2.p = NIM_NIL;
colontmpD__3.len = 0;
colontmpD__3.p = NIM_NIL;
T16_ = NIM_NIL;
T16_ = ((tyObject_IndexDefect__CqGtyJBJ5yAT9bbFUV4tGLw*) nimNewObj(sizeof(tyObject_IndexDefect__CqGtyJBJ5yAT9bbFUV4tGLw), NIM_ALIGNOF(tyObject_IndexDefect__CqGtyJBJ5yAT9bbFUV4tGLw)));
(*T16_).Sup.Sup.Sup.m_type = (&NTIv2__CqGtyJBJ5yAT9bbFUV4tGLw_);
(*T16_).Sup.Sup.name = "IndexDefect";
{
	NI T19_;
NimStringV2 blitTmp_1;
T19_ = ownArgv__stdZcmdline_u71.len;
if ((!((((NI) (T19_ - ((NI) 1))) < ((NI) 0))))) {
	goto LA20_;
}
...
T24_ = ownArgv__stdZcmdline_u71.len;
colontmpD__5 = dollar___systemZdollars_u9(((NI) (T24_ - ((NI) 1))));
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA15_;
}
...
eqwasMoved___system_u2621(((&colontmpD__3)));
