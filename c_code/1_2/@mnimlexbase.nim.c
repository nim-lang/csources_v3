...
T6_ = NIM_NIL;
T6_ = (*L_p0).stream;
charsRead_1 = llStreamRead__llstream_u435(T6_, ((void*) (((&(*L_p0).buf[toCopy_1])))), ((NI) ((*L_p0).sentinel + ((NI) 1))));
...
T23_ = NIM_NIL;
T23_ = (*L_p0).stream;
charsRead_1 = llStreamRead__llstream_u435(T23_, ((void*) (((&(*L_p0).buf[oldBufLen_1])))), oldBufLen_1);
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
{
...
{
		nimErr_ = nimErrorFlag();
llStreamClose__llstream_u180((*L_p0).stream);
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
}
