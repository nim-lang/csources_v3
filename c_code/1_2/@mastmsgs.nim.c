...
T2_[0] = colontmpD_;
colontmpD__2 = toFileLineCol__msgs_u686(conf_p1, (*sym_p2).info);
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA1_;
}
T2_[1] = colontmpD__2;
...
T7_.len = 0;
T7_.p = NIM_NIL;
colontmpD__3 = toFileLineCol__msgs_u686(conf_p1, (*(*typ_2).sym).info);
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA6_;
}
...
colontmpD__4.len = 0;
colontmpD__4.p = NIM_NIL;
colontmpD__3 = toFileLineCol__msgs_u686(conf_p0, (*disc_p2).info);
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA7_;
}
...
T7_.len = 0;
T7_.p = NIM_NIL;
colontmpD__3 = toFileLineCol__msgs_u686(conf_p1, (*(*typ_p2).sym).info);
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA6_;
}
T7_ = rawNewString((13 + colontmpD__3.len));
