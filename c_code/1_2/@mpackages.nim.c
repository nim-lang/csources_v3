...
filename_1 = toFullPath__msgs_u605(conf_p0, fileIdx_p2);
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA1_;
}
...
info_1 = newLineInfo__msgs_u400(fileIdx_p2, ((NI) 1), ((NI) 1));
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA1_;
}
pkgName_1 = getPackageName__options_u3728(conf_p0, filename_1);
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA1_;
}
