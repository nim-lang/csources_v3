...
N_LIB_PRIVATE N_NIMCALL(void, rawRemoveDir__stdZprivateZosdirs_u452)(NimStringV2 dir_p0);
...
T50_.len = 0;
T50_.p = NIM_NIL;
T50_ = substr__system_u8377(dir_p0, ((NI) 0), i_1);
...
rawRemoveDir__stdZprivateZosdirs_u452(dir_p0);
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
}
