...
T5_.len = 0;
T5_.p = NIM_NIL;
T5_ = substr__system_u8390(p_p0, ((NI) (checksumSeparatorIndex_1 + ((NI) 1))));
...
T16_.len = 0;
T16_.p = NIM_NIL;
T16_ = substr__system_u8377(p_p0, ((NI) (versionSeparatorIndex_1 + ((NI) 1))), ((NI) (checksumSeparatorIndex_1 - ((NI) 1))));
...
T22_.len = 0;
T22_.p = NIM_NIL;
T22_ = substr__system_u8377(p_p0, ((NI) (versionSeparatorIndex_1 + ((NI) 1))), ((NI) (checksumSeparatorIndex_1 - ((NI) 1))));
...
eqdestroy___system_u3753(sVer2_1);
eqdestroy___system_u3753(sVer_1);
goto BeforeRet_;
{
	LA15_: ;
}
...
getPathVersionChecksum__nimblecmd_u210(p_p2, ((&tmpTuple_1)));
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA1_;
}
...
eqwasMoved___system_u3750(((&resultX60gensym40__1)));
{
	NI T20_;
...
{
	eqdestroy___system_u2624(colontmpD_);
eqdestroy___system_u3753(nimbleLinkLines_1);
}
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA1_;
}
...
{
	eqdestroy___system_u3753(resultX60gensym40__1);
eqdestroy___system_u3753(nimbleLinks_1);
...
T16_ = ((NI32) 0);
T16_ = osLastError__stdZoserrors_u103();
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA7_;
}
raiseOSError__stdZoserrors_u100(T16_, dir_p1);
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA7_;
}
}
...
k_2 = ((tyEnum_PathComponent__wuLP2yUPe0lAU0NArPbn5g) 0);
{
	int T40_;
T40_ = ((int) 0);
T40_ = lstat(nimToCStringConv(path_1), ((&s_1)));
if ((!((T40_ < ((NI32) 0))))) {
	goto LA41_;
}
eqdestroy___system_u2624(path_1);
...
eqwasMoved___system_u2621(((&y_1)));
{
	NIM_BOOL T65_;
T65_ = ((NIM_BOOL) 0);
T65_ = (k_1 == ((tyEnum_PathComponent__wuLP2yUPe0lAU0NArPbn5g) 2));
if ((!(T65_))) {
	goto LA66_;
}
T65_ = (!((((NU8) (p_1).p->data[pos_1]) == ((NU8) 46))));
LA66_: ;
if ((!(T65_))) {
	goto LA67_;
}
...
NimStringV2 res_2;
T87_ = ((NIM_BOOL) 0);
T87_ = isFilled__pureZcollectionsZtables_u32((packages_1.data).p->data[h_1].Field0);
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA80_;
}
if ((!(T87_))) {
