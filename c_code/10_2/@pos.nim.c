...
colontmpD__2 = substr__system_u8390(path_p0, ((NI) 2));
...
T20_.len = 0;
T20_.p = NIM_NIL;
T20_ = substr__system_u8377(colontmp_, firstX60gensym37__1, ((NI) (lastX60gensym37__1 - ((NI) 1))));
...
T32_.len = 0;
T32_.p = NIM_NIL;
T32_ = substr__system_u8377(path_1, firstX60gensym34__1, ((NI) (lastX60gensym34__1 - ((NI) 1))));
...
result = initTime__pureZtimes_u1186(ts_p0.tv_sec, (ts_p0.tv_nsec));
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
}
