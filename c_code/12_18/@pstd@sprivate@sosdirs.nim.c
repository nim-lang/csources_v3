...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, rawCreateDir__stdZprivateZosdirs_u450)(NimStringV2 dir_p0);
...
N_LIB_PRIVATE N_NIMCALL(void, rawRemoveDir__stdZprivateZosdirs_u443)(NimStringV2 dir_p0);
...
result = ((NIM_BOOL) 0);
T1_ = ((NIM_BOOL) 0);
T1_ = rawCreateDir__stdZprivateZosdirs_u450(dir_p0);
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
result = (!(T1_));
...
T50_.len = 0;
T50_.p = NIM_NIL;
T50_ = substr__system_u8354(dir_p0, ((NI) 0), i_1);
...
rawRemoveDir__stdZprivateZosdirs_u443(dir_p0);
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
}
...
eqsink___system_u2633(((&path_1)), y_1);
eqwasMoved___system_u2621(((&y_1)));
nossplitPath(path_1, ((&colontmpD_)));
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA28_;
}
