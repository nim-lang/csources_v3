...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___system_u8464)(tyObject_IOError__WVAESVwIK7kcfBPG39aq7xQ* dest_p0);
...
close__stdZsyncio_u269((*((tyObject_FileStreamObj__LbEzkl9aTALZDJEfP9c09a3QQ*) (s_p0))).f);
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
...
NIM_BOOL* nimErr_;
{
		nimErr_ = nimErrorFlag();
result = ((NIM_BOOL) 0);
result = endOfFile__stdZsyncio_u370((*((tyObject_FileStreamObj__LbEzkl9aTALZDJEfP9c09a3QQ*) (s_p0))).f);
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
goto BeforeRet_;
...
{
		nimErr_ = nimErrorFlag();
setFilePos__stdZsyncio_u504((*((tyObject_FileStreamObj__LbEzkl9aTALZDJEfP9c09a3QQ*) (s_p0))).f, ((NI64) (pos_p1)), ((tyEnum_FileSeekPos__zmh28M4ny9aLYJKWY35a89cg) 0));
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
}
...
result = ((NI) 0);
T1_ = ((NI64) 0);
T1_ = getFilePos__stdZsyncio_u527((*((tyObject_FileStreamObj__LbEzkl9aTALZDJEfP9c09a3QQ*) (s_p0))).f);
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
result = ((NI) (T1_));
...
NIM_BOOL* nimErr_;
{
		nimErr_ = nimErrorFlag();
result = ((NIM_BOOL) 0);
result = readLine__stdZsyncio_u292((*((tyObject_FileStreamObj__LbEzkl9aTALZDJEfP9c09a3QQ*) (s_p0))).f, line_p1);
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
}
...
result = NIM_NIL;
eqdestroy___system_u8464(result);
...
{
		nimErr_ = nimErrorFlag();
flushFile__stdZsyncio_u279((*((tyObject_FileStreamObj__LbEzkl9aTALZDJEfP9c09a3QQ*) (s_p0))).f);
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
}
