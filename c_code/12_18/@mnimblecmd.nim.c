...
T5_.len = 0;
T5_.p = NIM_NIL;
T5_ = substr__system_u8367(p_p0, ((NI) (checksumSeparatorIndex_1 + ((NI) 1))));
...
T16_.len = 0;
T16_.p = NIM_NIL;
T16_ = substr__system_u8354(p_p0, ((NI) (versionSeparatorIndex_1 + ((NI) 1))), ((NI) (checksumSeparatorIndex_1 - ((NI) 1))));
...
T22_.len = 0;
T22_.p = NIM_NIL;
T22_ = substr__system_u8354(p_p0, ((NI) (versionSeparatorIndex_1 + ((NI) 1))), ((NI) (checksumSeparatorIndex_1 - ((NI) 1))));
...
eqdestroy___system_u3711(sVer2_1);
eqdestroy___system_u3711(sVer_1);
goto BeforeRet_;
{
	LA15_: ;
}
...
fX60gensym0__1.gl_offs = ((int) 0);
fX60gensym0__1.gl_pathc = ((int) 0);
...
NI32 colontmp__2;
NI32 res_1;
iX60gensym0__1 = ((NI32) 0);
colontmp__2 = ((NI32) 0);
colontmp__2 = ((NI32) (fX60gensym0__1.gl_pathc - ((NI32) 1)));
res_1 = ((NI32) 0);
{
	while (1) {
...
eqwasMoved___system_u3708(((&resultX60gensym40__1)));
{
	NI T20_;
...
{
	eqdestroy___system_u2624(colontmpD_);
eqdestroy___system_u3711(nimbleLinkLines_1);
}
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA1_;
}
...
{
	eqdestroy___system_u3711(resultX60gensym40__1);
eqdestroy___system_u3711(nimbleLinks_1);
