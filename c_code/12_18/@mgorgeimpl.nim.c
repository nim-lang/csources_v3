...
colontmp_.len = 0;
colontmp_.p = NIM_NIL;
colontmpD_ = toFullPath__msgs_u624(conf_p4, info_p3.fileIndex);
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA1_;
}
...
colontmpD__4 = T8_;
filename_1 = toGeneratedFile__options_u3823(conf_p4, colontmpD__4, TM__69a9b06YSkBJW7wqzuZfJ29aQ_10);
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA6_;
}
f_1 = 0;
...
T11_ = open__stdZsyncio_u414((&f_1), filename_1, ((tyEnum_FileMode__m6ZEz9b9czV5YJ5lg4IK9bc4Q) 0), ((NI) -1));
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA6_;
}
LA12_: ;
...
colontmp__3 = readAll__stdZsyncio_u383(f_1);
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA15_;
}
colontmp__4 = ((NI) 0);
...
eqsink___pureZosproc_u2004(((&result)), T16_);
...
if (NIM_UNLIKELY((*nimErr_))) {
	eqdestroy___pureZosproc_u216(T22_);
	goto LA20_;
}
p_1 = T22_;
{
...
eqsink___pureZosproc_u2004(((&result)), T32_);
nospclose(p_1);
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA20_;
}
...
writeFile__stdZsyncio_u540(filename_1, result.Field0);
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA20_;
}
}
...
T46_.len = 0;
T46_.p = NIM_NIL;
colontmpD__7 = getCurrentExceptionMsg__system_u7643();
...
eqsink___pureZosproc_u2004(((&result)), T47_);
...
if (NIM_UNLIKELY((*nimErr_))) {
	eqdestroy___pureZosproc_u216(T54_);
	goto LA52_;
}
p_2 = T54_;
{
...
eqsink___pureZosproc_u2004(((&result)), T64_);
nospclose(p_2);
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA52_;
}
...
{
	eqdestroy___pureZosproc_u216(p_2);
}
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA51_;
}
...
T70_.len = 0;
T70_.p = NIM_NIL;
colontmpD__10 = getCurrentExceptionMsg__system_u7643();
...
eqsink___pureZosproc_u2004(((&result)), T71_);
