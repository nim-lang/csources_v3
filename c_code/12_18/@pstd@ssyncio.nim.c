...
N_LIB_PRIVATE NIM_CONST tyArray__4aHJXb8P0zvBkj9aPCLWdGw FormatOpen__stdZsyncio_u405 = {"rb", "wb", "w+b", "r+b", "ab"};
N_LIB_PRIVATE NIM_CONST tyArray__4aHJXb8P0zvBkj9aPCLWdGw RawFormatOpen__stdZsyncio_u404 = {"rb", "wb", "w+b", "r+b", "ab"};
...
{
		nimErr_ = nimErrorFlag();
p_1 = fopen(nimToCStringConv(filename_p1), FormatOpen__stdZsyncio_u405[(mode_p2 - 0)]);
{
	FILE* f2_1;
struct stat res_1;
if ((!((!((p_1 == NIM_NIL)))))) {
...
T10_ = ((NIM_BOOL) 0);
T10_ = eqeq___system_u8298(T9_, ((NCSTRING) NIM_NIL));
fgetsSuccess_1 = (!(T10_));
{
	if ((!(fgetsSuccess_1))) {
	goto LA13_;
...
colontmpD_.len = 0;
colontmpD_.p = NIM_NIL;
colontmpD_ = readAllBuffer__stdZsyncio_u361(file_p0);
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA11_;
}
...
result = readAllFile__stdZsyncio_u374(file_p0, len_1);
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
}
...
LA8_: ;
{
	result = readAllBuffer__stdZsyncio_u361(file_p0);
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
}
...
f_1 = ((FILE*) NIM_NIL);
{
	NIM_BOOL T3_;
T3_ = ((NIM_BOOL) 0);
T3_ = open__stdZsyncio_u414((&f_1), filename_p0, ((tyEnum_FileMode__m6ZEz9b9czV5YJ5lg4IK9bc4Q) 0), ((NI) -1));
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
if ((!(T3_))) {
...
result = readAll__stdZsyncio_u383(f_1);
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA6_;
}
{
...
f_1 = ((FILE*) NIM_NIL);
{
	NIM_BOOL T3_;
T3_ = ((NIM_BOOL) 0);
T3_ = open__stdZsyncio_u414((&f_1), filename_p0, ((tyEnum_FileMode__m6ZEz9b9czV5YJ5lg4IK9bc4Q) 1), ((NI) -1));
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
if ((!(T3_))) {
...
result = newSeq__stdZsyncio_u579(n_p1);
{
	NI i_1;
NI colontmp_;
NI res_1;
...
LA4_: ;
(*f_p0) = fdopen(((int) (filehandle_p1)), RawFormatOpen__stdZsyncio_u404[(mode_p2 - 0)]);
...
N_LIB_PRIVATE N_NIMCALL(void, setFilePos__stdZsyncio_u504)(FILE* f_p0, NI64 pos_p1, tyEnum_FileSeekPos__zmh28M4ny9aLYJKWY35a89cg relativeTo_p2) {
	NIM_BOOL* nimErr_;
{
		nimErr_ = nimErrorFlag();
{
