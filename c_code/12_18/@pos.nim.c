...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, getApplHeuristic__pureZos_u184)(void);
...
static N_INLINE(struct timespec, st_mtim__posixZposix_u911)(struct stat s_p0);
...
colontmpD__2 = substr__system_u8367(path_p0, ((NI) 2));
...
T20_.len = 0;
T20_.p = NIM_NIL;
T20_ = substr__system_u8354(colontmp_, firstX60gensym37__1, ((NI) (lastX60gensym37__1 - ((NI) 1))));
...
T7_.len = 0;
T7_.p = NIM_NIL;
T7_ = getApplHeuristic__pureZos_u184();
if (NIM_UNLIKELY((*nimErr_))) {
...
T32_.len = 0;
T32_.p = NIM_NIL;
T32_ = substr__system_u8354(path_1, firstX60gensym34__1, ((NI) (lastX60gensym34__1 - ((NI) 1))));
...
int T6_;
T3_ = ((NIM_BOOL) 0);
T3_ = WIFSIGNALED__posixZposix_u865(status_p0);
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
if ((!(T3_))) {
...
T6_ = ((int) 0);
T6_ = WTERMSIG__posixZposix_u859(status_p0);
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
...
LA4_: ;
{
	colontmpD__2 = WEXITSTATUS__posixZposix_u849(status_p0);
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
result = colontmpD__2;
...
T2_ = ((int) 0);
T2_ = exitStatusLikeShell__pureZos_u162(T1_);
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
result = ((NI) (T2_));
...
result = initTime__pureZtimes_u1186(((NI64) (ts_p0.tv_sec)), (((NI) (ts_p0.tv_nsec))));
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
}
...
LA4_: ;
T7_ = st_mtim__posixZposix_u911(res_1);
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
