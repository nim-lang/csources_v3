...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, getApplFreebsd__pureZos_u196)(void);
...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, getApplHeuristic__pureZos_u225)(void);
...
static const NimStringV2 TM__yu6cxgKBBXbNsTkT9cyMd4g_23 = {4, ((NimStrPayload*) (&TM__yu6cxgKBBXbNsTkT9cyMd4g_18))};
...
static NIM_CONST tyArray__N9auXnwcX0YaPCc9cZcwg3KA TM__yu6cxgKBBXbNsTkT9cyMd4g_15 = {((int) 1), ((int) 14), ((int) 12), ((int) -1)};
...
colontmpD__2 = substr__system_u8346(path_p0, ((NI) 2));
...
NI realLen_1;
{
		result.len = 0;
result.p = NIM_NIL;
pathLength_1 = ((size_t) 0);
nimZeroMem(((void*) req_1), sizeof(tyArray__N9auXnwcX0YaPCc9cZcwg3KA));
nimCopyMem(((void*) req_1), ((NIM_CONST void*) TM__yu6cxgKBBXbNsTkT9cyMd4g_15), sizeof(tyArray__N9auXnwcX0YaPCc9cZcwg3KA));
res_1 = sysctl(((&req_1[(((NI) 0) - 0)])), ((unsigned int) 4), NIM_NIL, ((&pathLength_1)), NIM_NIL, ((size_t) 0));
{
	if ((!((res_1 < ((NI32) 0))))) {
	goto LA3_;
}
...
colontmp_.len = 0;
colontmp_.p = NIM_NIL;
colontmp_ = getEnv__stdZenvvars_u16(TM__yu6cxgKBBXbNsTkT9cyMd4g_19, TM__yu6cxgKBBXbNsTkT9cyMd4g_20);
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA8_;
}
...
T20_.len = 0;
T20_.p = NIM_NIL;
T20_ = substr__system_u8333(colontmp_, firstX60gensym37__1, ((NI) (lastX60gensym37__1 - ((NI) 1))));
...
result.len = 0;
result.p = NIM_NIL;
result = getApplFreebsd__pureZos_u196();
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
{
...
T7_.len = 0;
T7_.p = NIM_NIL;
T7_ = getApplHeuristic__pureZos_u225();
if (NIM_UNLIKELY((*nimErr_))) {
...
if (isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 258371072)) {
	(*nimErr_) = NIM_FALSE;
eqsink___system_u2633(((&result)), TM__yu6cxgKBBXbNsTkT9cyMd4g_21);
popCurrentException();
LA9_: ;
}
}
...
{
		nimErr_ = nimErrorFlag();
result = TM__yu6cxgKBBXbNsTkT9cyMd4g_22;
...
LA9_: ;
path_1 = getEnv__stdZenvvars_u16(TM__yu6cxgKBBXbNsTkT9cyMd4g_23, TM__yu6cxgKBBXbNsTkT9cyMd4g_24);
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA1_;
}
{
...
T32_.len = 0;
T32_.p = NIM_NIL;
T32_ = substr__system_u8333(path_1, firstX60gensym34__1, ((NI) (lastX60gensym34__1 - ((NI) 1))));
...
result = TM__yu6cxgKBBXbNsTkT9cyMd4g_25;
{
	LA1_: ;
}
{
