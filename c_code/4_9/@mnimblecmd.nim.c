...
T5_.len = 0;
T5_.p = NIM_NIL;
T5_ = substr__system_u8360(p_p0, ((NI) (checksumSeparatorIndex_1 + ((NI) 1))));
...
T16_.len = 0;
T16_.p = NIM_NIL;
T16_ = substr__system_u8347(p_p0, ((NI) (versionSeparatorIndex_1 + ((NI) 1))), ((NI) (checksumSeparatorIndex_1 - ((NI) 1))));
...
T22_.len = 0;
T22_.p = NIM_NIL;
T22_ = substr__system_u8347(p_p0, ((NI) (versionSeparatorIndex_1 + ((NI) 1))), ((NI) (checksumSeparatorIndex_1 - ((NI) 1))));
