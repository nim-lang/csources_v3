...
eqsink___pureZosproc_u2023(((&result)), T16_);
...
eqsink___pureZosproc_u2023(((&result)), T32_);
nospclose(p_1);
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA20_;
}
...
T46_.len = 0;
T46_.p = NIM_NIL;
colontmpD__7 = getCurrentExceptionMsg__system_u7655();
...
eqsink___pureZosproc_u2023(((&result)), T47_);
...
eqsink___pureZosproc_u2023(((&result)), T64_);
nospclose(p_2);
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA52_;
}
...
T70_.len = 0;
T70_.p = NIM_NIL;
colontmpD__10 = getCurrentExceptionMsg__system_u7655();
...
eqsink___pureZosproc_u2023(((&result)), T71_);
