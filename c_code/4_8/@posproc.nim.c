...
N_LIB_PRIVATE N_NIMCALL(NCSTRING*, allocCStringArray__system_u3843)(NimStringV2* a_p0, NI a_p0Len_0);
...
N_LIB_PRIVATE N_NIMCALL(void, deallocCStringArray__system_u3897)(NCSTRING* a_p0);
...
void* T15_;
T12_ = ((NIM_BOOL) 0);
T12_ = eqeq___system_u8272(environ[i_3], ((NCSTRING) NIM_NIL));
if ((!((!(T12_))))) {
	goto LA11;
}
kv_2.len = 0;
...
T13_.Field0 = substr__system_u8328(kv_2, ((NI) 0), ((NI) (p_2 - ((NI) 1))));
T13_.Field1 = substr__system_u8341(kv_2, ((NI) (p_2 + ((NI) 1))));
...
LA27_: ;
flags_1 = ((NI32) (((int) 0) | POSIX_SPAWN_SETSIGMASK));
{
	if ((!((((*data_p0).options & (((NU8) 1) << (((NU) ((tyEnum_ProcessOption__9aCfVUyDFjLLn9an3vvc7WLw) 6)) & 7U))) != 0)))) {
	goto LA37_;
}
...
LA18_: ;
pid_1 = ((pid_t) 0);
sysArgs_1 = allocCStringArray__system_u3843(((sysArgsRaw_1).p ? (sysArgsRaw_1).p->data : NIM_NIL), sysArgsRaw_1.len);
...
setCurrentDir__stdZprivateZosdirs_u522(currentDir_1);
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA33_;
}
}
...
{
	deallocCStringArray__system_u3897(sysEnv_1);
}
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA26_;
}
...
{
	deallocCStringArray__system_u3897(sysArgs_1);
}
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA1_;
}
...
{
	eqdestroy___system_u3752(sysArgsRaw_1);
