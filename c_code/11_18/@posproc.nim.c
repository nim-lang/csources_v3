...
void* T15_;
T12_ = ((NIM_BOOL) 0);
T12_ = eqeq___system_u8303(environ[i_3], ((NCSTRING) NIM_NIL));
if ((!((!(T12_))))) {
	goto LA11;
}
kv_2.len = 0;
...
T13_.Field0 = substr__system_u8359(kv_2, ((NI) 0), ((NI) (p_2 - ((NI) 1))));
T13_.Field1 = substr__system_u8372(kv_2, ((NI) (p_2 + ((NI) 1))));
