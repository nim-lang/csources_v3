...
eqsink___pureZosproc_u1961(((&result)), T16_);
...
eqsink___pureZosproc_u1961(((&result)), T32_);
nospclose(p_1);
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA20_;
}
...
eqsink___pureZosproc_u1961(((&result)), T47_);
...
eqsink___pureZosproc_u1961(((&result)), T64_);
nospclose(p_2);
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA52_;
}
...
eqsink___pureZosproc_u1961(((&result)), T71_);
