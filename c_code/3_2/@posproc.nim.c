...
void* T17_;
T14_ = ((NIM_BOOL) 0);
T14_ = eqeq___system_u8284(gEnv_2[i_3], ((NCSTRING) NIM_NIL));
if ((!((!(T14_))))) {
	goto LA13;
}
kv_2.len = 0;
...
T15_.Field0 = substr__system_u8340(kv_2, ((NI) 0), ((NI) (p_2 - ((NI) 1))));
T15_.Field1 = substr__system_u8353(kv_2, ((NI) (p_2 + ((NI) 1))));
