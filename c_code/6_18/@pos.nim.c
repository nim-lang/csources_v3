...
static N_INLINE(struct timespec, st_mtim__posixZposix_u1060)(struct stat s_p0);
...
static NIM_CONST tyArray__N9auXnwcX0YaPCc9cZcwg3KA TM__yu6cxgKBBXbNsTkT9cyMd4g_15 = {((int) 1), ((int) 48), ((int) -1), ((int) 5)};
...
result.len = 0;
result.p = NIM_NIL;
result = getApplFreebsd__pureZos_u197();
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
{
...
LA4_: ;
T7_ = st_mtim__posixZposix_u1060(res_1);
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
