...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, getApplHaiku__pureZos_u197)(void);
...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, getApplHeuristic__pureZos_u185)(void);
...
static const NimStringV2 TM__yu6cxgKBBXbNsTkT9cyMd4g_21 = {4, ((NimStrPayload*) (&TM__yu6cxgKBBXbNsTkT9cyMd4g_16))};
...
colontmpD__2 = substr__system_u8371(path_p0, ((NI) 2));
...
NI realLen_1;
T3_ = ((NI32) 0);
T3_ = find_path(NIM_NIL, ((int) 1000), ((NCSTRING) NIM_NIL), nimToCStringConv(result), ((size_t) 1024));
if ((!((T3_ == ((NI32) 0))))) {
	goto LA4_;
}
realLen_1 = nimCStrLen(nimToCStringConv(result));
setLengthStrV2(((&result)), (realLen_1));
}
goto LA1_;
LA4_: ;
{
	eqsink___system_u2633(((&result)), TM__yu6cxgKBBXbNsTkT9cyMd4g_15);
}
LA1_: ;
	return result;
}
...
colontmp_.len = 0;
colontmp_.p = NIM_NIL;
colontmp_ = getEnv__stdZenvvars_u16(TM__yu6cxgKBBXbNsTkT9cyMd4g_17, TM__yu6cxgKBBXbNsTkT9cyMd4g_18);
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA8_;
}
...
T20_.len = 0;
T20_.p = NIM_NIL;
T20_ = substr__system_u8358(colontmp_, firstX60gensym37__1, ((NI) (lastX60gensym37__1 - ((NI) 1))));
...
result.len = 0;
result.p = NIM_NIL;
result = getApplHaiku__pureZos_u197();
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
{
...
T7_.len = 0;
T7_.p = NIM_NIL;
T7_ = getApplHeuristic__pureZos_u185();
if (NIM_UNLIKELY((*nimErr_))) {
...
if (isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 258371072)) {
	(*nimErr_) = NIM_FALSE;
eqsink___system_u2633(((&result)), TM__yu6cxgKBBXbNsTkT9cyMd4g_19);
popCurrentException();
LA9_: ;
}
}
...
T5_ = ((NI32) 0);
T5_ = osLastError__stdZoserrors_u103();
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
raiseOSError__stdZoserrors_u100(T5_, filename_p0);
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
}
...
LA9_: ;
path_1 = getEnv__stdZenvvars_u16(TM__yu6cxgKBBXbNsTkT9cyMd4g_21, TM__yu6cxgKBBXbNsTkT9cyMd4g_22);
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA1_;
}
{
...
T32_.len = 0;
T32_.p = NIM_NIL;
T32_ = substr__system_u8358(path_1, firstX60gensym34__1, ((NI) (lastX60gensym34__1 - ((NI) 1))));
...
raiseOSError__stdZoserrors_u100(T60_, exe_p0);
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA55_;
}
}
...
raiseOSError__stdZoserrors_u100(T6_, file_p0);
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
}
