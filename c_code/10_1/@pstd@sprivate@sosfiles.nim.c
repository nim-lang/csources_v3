...
NI32 T28_;
T25_ = ((NIM_BOOL) 0);
T25_ = open__stdZsyncio_u414((&s_1), source_p0, ((tyEnum_FileMode__m6ZEz9b9czV5YJ5lg4IK9bc4Q) 0), ((NI) -1));
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
if ((!((!(T25_))))) {
...
T28_ = ((NI32) 0);
T28_ = osLastError__stdZoserrors_u103();
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
raiseOSError__stdZoserrors_u100(T28_, source_p0);
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
}
...
NI32 T34_;
T31_ = ((NIM_BOOL) 0);
T31_ = open__stdZsyncio_u414((&d_1), dest_p1, ((tyEnum_FileMode__m6ZEz9b9czV5YJ5lg4IK9bc4Q) 1), ((NI) -1));
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
if ((!((!(T31_))))) {
...
raiseOSError__stdZoserrors_u100(T34_, dest_p1);
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
}
...
close__stdZsyncio_u269(d_1);
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
T45_ = ((NI32) 0);
T45_ = osLastError__stdZoserrors_u103();
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
raiseOSError__stdZoserrors_u100(T45_, dest_p1);
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
}
...
flushFile__stdZsyncio_u279(d_1);
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
close__stdZsyncio_u269(d_1);
...
NimStringV2 colontmpD_;
NI32 T50_;
tyTuple__DsrvAZq6be9c2gVX0ziBbKA T51_;
T46_ = ((int) 0);
...
raiseOSError__stdZoserrors_u100(T50_, colontmpD_);
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA49_;
}
{
...
raiseOSError__stdZoserrors_u100(T6_, filename_p0);
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
}
...
result = 0;
{
	if ((!((!((((NU32) (a_1.st_mode & ((mode_t) (S_IRUSR)))) == ((mode_t) 0))))))) {
	goto LA9_;
}
...
LA9_: ;
{
	if ((!((!((((NU32) (a_1.st_mode & ((mode_t) (S_IWUSR)))) == ((mode_t) 0))))))) {
	goto LA13_;
}
...
LA13_: ;
{
	if ((!((!((((NU32) (a_1.st_mode & ((mode_t) (S_IXUSR)))) == ((mode_t) 0))))))) {
	goto LA17_;
}
...
LA17_: ;
{
	if ((!((!((((NU32) (a_1.st_mode & ((mode_t) (S_IRGRP)))) == ((mode_t) 0))))))) {
	goto LA21_;
}
...
LA21_: ;
{
	if ((!((!((((NU32) (a_1.st_mode & ((mode_t) (S_IWGRP)))) == ((mode_t) 0))))))) {
	goto LA25_;
}
...
LA25_: ;
{
	if ((!((!((((NU32) (a_1.st_mode & ((mode_t) (S_IXGRP)))) == ((mode_t) 0))))))) {
	goto LA29_;
}
...
LA29_: ;
{
	if ((!((!((((NU32) (a_1.st_mode & ((mode_t) (S_IROTH)))) == ((mode_t) 0))))))) {
	goto LA33_;
}
...
LA33_: ;
{
	if ((!((!((((NU32) (a_1.st_mode & ((mode_t) (S_IWOTH)))) == ((mode_t) 0))))))) {
	goto LA37_;
}
...
LA37_: ;
{
	if ((!((!((((NU32) (a_1.st_mode & ((mode_t) (S_IXOTH)))) == ((mode_t) 0))))))) {
	goto LA41_;
}
...
copyFileWithPermissions__stdZprivateZosfiles_u363(source_p0, dest_p1, NIM_TRUE, 1);
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
