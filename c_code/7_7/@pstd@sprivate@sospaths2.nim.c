...
T4_ = ((NIM_CHAR) 0);
T4_ = X5BX5D___system_u7753(tail_p2, ((NI) 1));
...
T10_ = ((NIM_CHAR*) 0);
T10_ = X5BX5D___system_u7805(result_p0, ((NI) 1));
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
...
T19_.len = 0;
T19_.p = NIM_NIL;
T19_ = substr__system_u8338(path_p0, ((NI) 0), T12_);
eqsink___system_u2633(((&result.Field0)), T19_);
T20_.len = 0;
T20_.p = NIM_NIL;
T20_ = substr__system_u8351(path_p0, ((NI) (sepPos_1 + ((NI) 1))));
...
T21_.len = 0;
T21_.p = NIM_NIL;
T21_ = substr__system_u8338(path_p0, ((NI) 0), T14_);
...
T26_.len = 0;
T26_.p = NIM_NIL;
T26_ = substr__system_u8338(path_p0, namePos_1, ((NI) (dotPos_1 - ((NI) 1))));
eqsink___system_u2633(((&result.Field1)), T26_);
T27_.len = 0;
T27_.p = NIM_NIL;
T27_ = substr__system_u8351(path_p0, dotPos_1);
...
T29_.len = 0;
T29_.p = NIM_NIL;
T29_ = substr__system_u8351(path_p0, namePos_1);
...
T6_ = ((NIM_BOOL) 0);
T6_ = eqeq___system_u8282(T5_, ((NCSTRING) NIM_NIL));
if ((!((!(T6_))))) {
	goto LA7_;
}
T9_ = ((size_t) 0);
...
T54_ = ((NIM_CHAR*) 0);
T54_ = X5BX5D___system_u7805(((&result)), ((NI) 1));
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA1_;
}
...
T72_ = ((NIM_CHAR*) 0);
T72_ = X5BX5D___system_u7805(((&result)), ((NI) 1));
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA1_;
}
...
T5_.len = 0;
T5_.p = NIM_NIL;
T5_ = substr__system_u8338(result, ((NI) 0), sepPos_1);
...
T13_ = ((NIM_CHAR*) 0);
T13_ = X5BX5D___system_u7805(((&result)), ((NI) 1));
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
...
T7_.len = 0;
T7_.p = NIM_NIL;
colontmpD__2 = substr__system_u8338(filename_p0, ((NI) 0), ((NI) (extPos_1 - ((NI) 1))));
