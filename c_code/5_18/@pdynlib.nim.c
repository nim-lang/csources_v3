...
suffix_1.len = 0;
suffix_1.p = NIM_NIL;
prefix_1 = substr__system_u8362(s_p0, ((NI) 0), ((NI) (le_1 - ((NI) 1))));
suffix_1 = substr__system_u8375(s_p0, ((NI) (ri_1 + ((NI) 1))));
{
...
colontmp_.len = 0;
colontmp_.p = NIM_NIL;
colontmp_ = substr__system_u8362(s_p0, ((NI) (le_1 + ((NI) 1))), ((NI) (ri_1 - ((NI) 1))));
...
T21_.len = 0;
T21_.p = NIM_NIL;
T21_ = substr__system_u8362(colontmp_, firstX60gensym34__1, ((NI) (lastX60gensym34__1 - ((NI) 1))));
