...
{
		nimErr_ = nimErrorFlag();
setFilePos__stdZsyncio_u499((*((tyObject_FileStreamObj__LbEzkl9aTALZDJEfP9c09a3QQ*) (s_p0))).f, ((NI64) (pos_p1)), ((tyEnum_FileSeekPos__zmh28M4ny9aLYJKWY35a89cg) 0));
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
}
...
result = ((NI) 0);
T1_ = ((NI64) 0);
T1_ = getFilePos__stdZsyncio_u522((*((tyObject_FileStreamObj__LbEzkl9aTALZDJEfP9c09a3QQ*) (s_p0))).f);
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
result = ((NI) (T1_));
...
f_1 = 0;
{
	NIM_BOOL T3_;
T3_ = ((NIM_BOOL) 0);
T3_ = open__stdZsyncio_u415((&f_1), filename_p0, mode_p1, bufSize_p2);
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
if ((!(T3_))) {
