...
NI32 T28_;
T25_ = ((NIM_BOOL) 0);
T25_ = open__stdZsyncio_u415((&s_1), source_p0, ((tyEnum_FileMode__m6ZEz9b9czV5YJ5lg4IK9bc4Q) 0), ((NI) -1));
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
if ((!((!(T25_))))) {
...
NI32 T34_;
T31_ = ((NIM_BOOL) 0);
T31_ = open__stdZsyncio_u415((&d_1), dest_p1, ((tyEnum_FileMode__m6ZEz9b9czV5YJ5lg4IK9bc4Q) 1), ((NI) -1));
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
if ((!((!(T31_))))) {
...
LA32_: ;
T35_ = ((int) 0);
T35_ = getFileHandle__stdZsyncio_u280(d_1);
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
T36_ = ((int) 0);
...
(void)T36_;
T37_ = ((int) 0);
T37_ = getFileHandle__stdZsyncio_u280(s_1);
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
T38_ = ((int) 0);
...
result = 0;
{
	if ((!((!((((NU32) (a_1.st_mode & ((mode_t) 256))) == ((mode_t) 0))))))) {
	goto LA9_;
}
...
LA9_: ;
{
	if ((!((!((((NU32) (a_1.st_mode & ((mode_t) 128))) == ((mode_t) 0))))))) {
	goto LA13_;
}
...
LA13_: ;
{
	if ((!((!((((NU32) (a_1.st_mode & ((mode_t) 64))) == ((mode_t) 0))))))) {
	goto LA17_;
}
...
LA17_: ;
{
	if ((!((!((((NU32) (a_1.st_mode & ((mode_t) 32))) == ((mode_t) 0))))))) {
	goto LA21_;
}
...
LA21_: ;
{
	if ((!((!((((NU32) (a_1.st_mode & ((mode_t) 16))) == ((mode_t) 0))))))) {
	goto LA25_;
}
...
LA25_: ;
{
	if ((!((!((((NU32) (a_1.st_mode & ((mode_t) 8))) == ((mode_t) 0))))))) {
	goto LA29_;
}
...
LA29_: ;
{
	if ((!((!((((NU32) (a_1.st_mode & ((mode_t) 4))) == ((mode_t) 0))))))) {
	goto LA33_;
}
...
LA33_: ;
{
	if ((!((!((((NU32) (a_1.st_mode & ((mode_t) 2))) == ((mode_t) 0))))))) {
	goto LA37_;
}
...
LA37_: ;
{
	if ((!((!((((NU32) (a_1.st_mode & ((mode_t) 1))) == ((mode_t) 0))))))) {
	goto LA41_;
}
