...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, modeIsDir__stdZsyncio_u409)(mode_t m_p0);
...
T7_ = modeIsDir__stdZsyncio_u409(res_1.st_mode);
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
LA10_: ;
...
NimStringV2 T7_;
T3_ = ((NIM_BOOL) 0);
T3_ = open__stdZsyncio_u415((&result), filename_p0, mode_p1, bufSize_p2);
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
if ((!((!(T3_))))) {
...
f_1 = ((FILE*) NIM_NIL);
{
	NIM_BOOL T3_;
T3_ = ((NIM_BOOL) 0);
T3_ = open__stdZsyncio_u415((&f_1), filename_p0, ((tyEnum_FileMode__m6ZEz9b9czV5YJ5lg4IK9bc4Q) 0), ((NI) -1));
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
if ((!(T3_))) {
...
f_1 = ((FILE*) NIM_NIL);
{
	NIM_BOOL T3_;
T3_ = ((NIM_BOOL) 0);
T3_ = open__stdZsyncio_u415((&f_1), filename_p0, ((tyEnum_FileMode__m6ZEz9b9czV5YJ5lg4IK9bc4Q) 1), ((NI) -1));
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
if ((!(T3_))) {
...
result = newSeq__stdZsyncio_u574(n_p1);
{
	NI i_1;
NI colontmp_;
NI res_1;
...
N_LIB_PRIVATE N_NIMCALL(void, setFilePos__stdZsyncio_u499)(FILE* f_p0, NI64 pos_p1, tyEnum_FileSeekPos__zmh28M4ny9aLYJKWY35a89cg relativeTo_p2) {
	NIM_BOOL* nimErr_;
{
		nimErr_ = nimErrorFlag();
{
...
N_LIB_PRIVATE N_NIMCALL(NI64, getFilePos__stdZsyncio_u522)(FILE* f_p0) {
	NI64 result;
NIM_BOOL* nimErr_;
{
		nimErr_ = nimErrorFlag();
