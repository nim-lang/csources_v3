...
T20_.len = 0;
T20_.p = NIM_NIL;
T20_ = substr__system_u8340(colontmp_, firstX60gensym37__1, ((NI) (lastX60gensym37__1 - ((NI) 1))));
...
T32_.len = 0;
T32_.p = NIM_NIL;
T32_ = substr__system_u8340(path_1, firstX60gensym34__1, ((NI) (lastX60gensym34__1 - ((NI) 1))));
...
LA4_: ;
{
	colontmpD__2 = WEXITSTATUS__posixZposix_u1063(status_p0);
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
result = colontmpD__2;
