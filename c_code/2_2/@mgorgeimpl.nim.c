...
T11_ = open__stdZsyncio_u415((&f_1), filename_1, ((tyEnum_FileMode__m6ZEz9b9czV5YJ5lg4IK9bc4Q) 0), ((NI) -1));
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA6_;
}
LA12_: ;
...
colontmp__3 = readAll__stdZsyncio_u381(f_1);
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA15_;
}
colontmp__4 = ((NI) 0);
...
writeFile__stdZsyncio_u535(filename_1, result.Field0);
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA20_;
}
}
...
T46_.len = 0;
T46_.p = NIM_NIL;
colontmpD__7 = getCurrentExceptionMsg__system_u7629();
...
T70_.len = 0;
T70_.p = NIM_NIL;
colontmpD__10 = getCurrentExceptionMsg__system_u7629();
