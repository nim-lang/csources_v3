...
T5_.len = 0;
T5_.p = NIM_NIL;
T5_ = substr__system_u8353(p_p0, ((NI) (checksumSeparatorIndex_1 + ((NI) 1))));
...
T16_.len = 0;
T16_.p = NIM_NIL;
T16_ = substr__system_u8340(p_p0, ((NI) (versionSeparatorIndex_1 + ((NI) 1))), ((NI) (checksumSeparatorIndex_1 - ((NI) 1))));
...
T22_.len = 0;
T22_.p = NIM_NIL;
T22_ = substr__system_u8340(p_p0, ((NI) (versionSeparatorIndex_1 + ((NI) 1))), ((NI) (checksumSeparatorIndex_1 - ((NI) 1))));
...
fX60gensym0__1.gl_offs = ((size_t) 0);
fX60gensym0__1.gl_pathc = ((size_t) 0);
...
NU64 colontmp__2;
NU64 res_1;
iX60gensym0__1 = ((NU64) 0);
colontmp__2 = ((NU64) 0);
colontmp__2 = ((NU64) (((NU) (((NU64) fX60gensym0__1.gl_pathc) - ((NU64) ((NU) 1))))));
res_1 = 0ULL;
{
	while (1) {
...
colontmpD_.len = 0;
colontmpD_.p = NIM_NIL;
colontmpD_ = readFile__stdZsyncio_u530((nimbleLinks_1).p->data[((NI) 0)]);
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA23_;
}
