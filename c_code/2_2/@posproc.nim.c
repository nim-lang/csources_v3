...
typedef unsigned long tyArray__D9bOSe56wsODtgDSDjfI3Lg[16];
typedef int tyArray__tBYXtRPQ9ar4q9ae8bPRfKww[16];
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, open__stdZsyncio_u478)(FILE** f_p0, int filehandle_p1, tyEnum_FileMode__m6ZEz9b9czV5YJ5lg4IK9bc4Q mode_p2);
...
NI32 T6_;
T3_ = ((NIM_BOOL) 0);
T3_ = open__stdZsyncio_u478((&f_1), (*handle_p0), fileMode_p1);
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
if ((!((!(T3_))))) {
...
T43_ = ((int) 0);
T43_ = clock_nanosleep(((int) 1), ((int) 1), ((&waitSpec_1)), ((&unused_1)));
(void)T43_;
...
}
{
	NIM_BOOL T32_;
T32_ = ((NIM_BOOL) 0);
T32_ = WIFEXITED__posixZposix_u1076(status_1);
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA5_;
}
if (T32_) {
...
T32_ = WIFSIGNALED__posixZposix_u1079(status_1);
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA5_;
}
LA33_: ;
