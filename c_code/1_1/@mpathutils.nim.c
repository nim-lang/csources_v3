...
static const struct {
	NI cap;
	NIM_CHAR data[7];
} TM__r4WvUOkTx4ylahJtpRE9aTQ_2 = {(6 | NIM_STRLIT_FLAG), "Users/"};
static const NimStringV2 TM__r4WvUOkTx4ylahJtpRE9aTQ_3 = {6, ((NimStrPayload*) (&TM__r4WvUOkTx4ylahJtpRE9aTQ_2))};
static const struct {
	NI cap;
	NIM_CHAR data[8];
} TM__r4WvUOkTx4ylahJtpRE9aTQ_4 = {(7 | NIM_STRLIT_FLAG), "//user/"};
...
T9_.p = NIM_NIL;
T9_ = base_2;
addNormalizePath__pureZpathnorm_u87(T9_, ((&result)), ((&state_1)), 92);
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA1_;
}
T10_.len = 0;
T10_.p = NIM_NIL;
T10_ = f_p1;
addNormalizePath__pureZpathnorm_u87(T10_, ((&result)), ((&state_1)), 92);
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA1_;
}
{
		...
		nimErr_ = nimErrorFlag();
{
	NIM_BOOL T3_;
T3_ = ((NIM_BOOL) 0);
T3_ = nsuContinuesWith(x_p0, TM__r4WvUOkTx4ylahJtpRE9aTQ_3, ((NI) 3));
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
if ((!(T3_))) {
...
colontmpD__2 = slash___stdZprivateZospaths2_u90(colontmpD_, x_p0);
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA6_;
}
colontmpD__3 = nsuReplaceChar(colontmpD__2, 92, 47);
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA6_;
}
result = customPathImpl__pathutils_u250(colontmpD__3);
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA6_;
}
{
...
T14_.len = 0;
T14_.p = NIM_NIL;
colontmpD__4 = relevantPart__pathutils_u233(x_p0, slashes_1);
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
T14_ = rawNewString((7 + colontmpD__4.len));
appendString(((&T14_)), TM__r4WvUOkTx4ylahJtpRE9aTQ_5);
...
colontmpD_.len = 0;
colontmpD_.p = NIM_NIL;
colontmpD_ = nsuReplaceChar(x_p0, 92, 47);
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA1_;
}
result = customPathImpl__pathutils_u250(colontmpD_);
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA1_;
}
{
