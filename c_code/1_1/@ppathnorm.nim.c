...
x_2.len = 0;
x_2.p = NIM_NIL;
eqcopy___system_u2627(((&x_2)), x_p0);
{
...
file_1.len = 0;
file_1.p = NIM_NIL;
tmpTuple_1 = splitDrive__stdZprivateZntpath_u2(x_2);
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
...
eqsink___system_u2633(((&x_2)), file_1);
prepareAdd(((&(*result_p1))), (0 + drive_1.len));
...
{
	if ((!(((((NU8) (*c_1)) == ((NU8) 92)) || (((NU8) (*c_1)) == ((NU8) 47)))))) {
	goto LA10_;
}
(*c_1) = dirSep_p3;
}
...
}
{
	NIM_BOOL T25_;
T25_ = ((NIM_BOOL) 0);
T25_ = (((NI) (((NI32) (*state_p2)) >> ((NU32) ((NI) 1)))) == ((NI) 0));
if ((!(T25_))) {
	goto LA26_;
}
...
LA56_: ;
colontmpD_ = substr__system_u8372(x_2, b_1.Field0, b_1.Field1);
...
LA69_: ;
colontmpD__2 = substr__system_u8372(x_2, b_1.Field0, b_1.Field1);
