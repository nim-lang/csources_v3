...
colontmpD__2 = substr__system_u8385(path_p0, ((NI) 2));
...
colontmpD__2 = nossplitFile(result);
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA26_;
}
...
T27_.len = 0;
T27_.p = NIM_NIL;
T27_ = substr__system_u8372(path_1, firstX60gensym34__1, ((NI) (lastX60gensym34__1 - ((NI) 1))));
...
T39_ = ((NIM_CHAR) 0);
T39_ = X5BX5D___system_u7787(candidate_1, ((NI) 1));
if (NIM_UNLIKELY((*nimErr_))) {
	goto LA29_;
}
...
colontmpD_ = substr__system_u8372(candidate_1, ((NI) 1), ((NI) (candidate_1.len - ((NI) 2))));
T34_ = colontmpD_;
}
goto LA35_;
LA40_: ;
