...
result = getEnv__stdZenvvars_u36(key_p2, TM__ZT9crccxweoChVXn9cHcxIXQ_10);
if (NIM_UNLIKELY((*nimErr_))) {
	goto BeforeRet_;
}
}
...
colontmpD_ = substr__system_u8372(f_p0, ((NI) (i_1 + ((NI) 2))), ((NI) (j_1 - ((NI) 1))));
...
colontmpD__3 = substr__system_u8372(f_p0, ((NI) (i_1 + ((NI) 1))), ((NI) (j_2 - ((NI) 1))));
