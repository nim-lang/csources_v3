...
result.len = 0;
result.p = NIM_NIL;
result = rawNewString((((NI) (estimate_p1 + ((NI) (((NI32) estimate_p1) >> ((NU32) ((NI) 2))))))));
i_1 = ((NI) 0);
{
	while (1) {
	NI ch_1;
...
ch_1 = ((NI) (((NI) (((NI) (((NU32) ((NI) (ch_1 & ((NI) 1023)))) << ((NU32) ((NI) 10)))) + ((NI) (ch2_1 & ((NI) 1023))))) + ((NI) 65536)));
i_1 += ((NI) 1);
}
goto LA9_;
LA13_: ;
...
nimAddCharV1(((&result)), ((NIM_CHAR) ((((NI) (((NI) (((NI32) ch_1) >> ((NU32) ((NI) 6)))) | ((NI) 192)))))));
...
nimAddCharV1(((&result)), ((NIM_CHAR) ((((NI) (((NI) (((NI32) ch_1) >> ((NU32) ((NI) 12)))) | ((NI) 224)))))));
nimAddCharV1(((&result)), ((NIM_CHAR) ((((NI) (((NI) (((NI) (((NI32) ch_1) >> ((NU32) ((NI) 6)))) & ((NI) 63))) | ((NI) 128)))))));
nimAddCharV1(((&result)), ((NIM_CHAR) ((((NI) (((NI) (ch_1 & ((NI) 63))) | ((NI) 128)))))));
}
goto LA21_;
LA29_: ;
...
nimAddCharV1(((&result)), ((NIM_CHAR) ((((NI) (((NI) (((NI32) ch_1) >> ((NU32) ((NI) 18)))) | ((NI) 240)))))));
nimAddCharV1(((&result)), ((NIM_CHAR) ((((NI) (((NI) (((NI) (((NI32) ch_1) >> ((NU32) ((NI) 12)))) & ((NI) 63))) | ((NI) 128)))))));
nimAddCharV1(((&result)), ((NIM_CHAR) ((((NI) (((NI) (((NI) (((NI32) ch_1) >> ((NU32) ((NI) 6)))) & ((NI) 63))) | ((NI) 128)))))));
nimAddCharV1(((&result)), ((NIM_CHAR) ((((NI) (((NI) (ch_1 & ((NI) 63))) | ((NI) 128)))))));
}
goto LA21_;
...
LA6_: ;
{
	if ((!((((NI) (((NI32) ((NU8) source_p0[i_1])) >> ((NU32) ((NI) 5)))) == ((NI) 6))))) {
	goto LA9_;
}
{
	if ((!((i_1 <= ((NI) (L_p1 - ((NI) 2))))))) {
...
result_2 = ((NI) (((NI) (((NU32) ((NI) (((NU8) source_p0[i_1]) & ((NI) 31)))) << ((NU32) ((NI) 6)))) | ((NI) (((NU8) source_p0[((NI) (i_1 + ((NI) 1)))]) & ((NI) 63)))));
i_1 += ((NI) 2);
}
goto LA11_;
LA13_: ;
...
LA9_: ;
{
	if ((!((((NI) (((NI32) ((NU8) source_p0[i_1])) >> ((NU32) ((NI) 4)))) == ((NI) 14))))) {
	goto LA17_;
}
{
	if ((!((i_1 <= ((NI) (L_p1 - ((NI) 3))))))) {
...
result_2 = ((NI) (((NI) (((NI) (((NU32) ((NI) (((NU8) source_p0[i_1]) & ((NI) 15)))) << ((NU32) ((NI) 12)))) | ((NI) (((NU32) ((NI) (((NU8) source_p0[((NI) (i_1 + ((NI) 1)))]) & ((NI) 63)))) << ((NU32) ((NI) 6)))))) | ((NI) (((NU8) source_p0[((NI) (i_1 + ((NI) 2)))]) & ((NI) 63)))));
i_1 += ((NI) 3);
}
goto LA19_;
LA21_: ;
...
LA17_: ;
{
	if ((!((((NI) (((NI32) ((NU8) source_p0[i_1])) >> ((NU32) ((NI) 3)))) == ((NI) 30))))) {
	goto LA25_;
}
{
	if ((!((i_1 <= ((NI) (L_p1 - ((NI) 4))))))) {
...
result_2 = ((NI) (((NI) (((NI) (((NI) (((NU32) ((NI) (((NU8) source_p0[i_1]) & ((NI) 7)))) << ((NU32) ((NI) 18)))) | ((NI) (((NU32) ((NI) (((NU8) source_p0[((NI) (i_1 + ((NI) 1)))]) & ((NI) 63)))) << ((NU32) ((NI) 12)))))) | ((NI) (((NU32) ((NI) (((NU8) source_p0[((NI) (i_1 + ((NI) 2)))]) & ((NI) 63)))) << ((NU32) ((NI) 6)))))) | ((NI) (((NU8) source_p0[((NI) (i_1 + ((NI) 3)))]) & ((NI) 63)))));
i_1 += ((NI) 4);
}
goto LA27_;
LA29_: ;
...
result.data[d_1] = ((NI16) (((NU16) (((NI) (((NI) (((NI32) ch_2) >> ((NU32) ((NI) 10)))) + ((NI) 55296)))))));
d_1 += ((NI) 1);
